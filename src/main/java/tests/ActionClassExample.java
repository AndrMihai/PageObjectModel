...
public class ActionClassExample extends BaseTest {
	...
	public void sendKeysExample() throws InterruptedException {
		...
		contacts.sendKeysWithCaps(contacts.nameField, "poofwoof");
	}
	//@Test(priority=1)
	...
	public void copyPasteExample() {
		...
		action.moveToElement(password).click().pause(Duration.ofSeconds(2)).keyDown(ctrlKey).sendKeys("v").keyUp(ctrlKey).pause(Duration.ofSeconds(2)).perform();
