...
public class XpatchExample2 extends BaseTest {
	@Test
	public void xpathExample() {
		...
		loginMenu.click();
		//descendant & child
		//toate xpath-urile de mai jos fac fix acelasi lucru
		...
		//---> //ul//input[@id='log'] best optimized
		...
		//following --> coboara in dom fara avea nevoie de o relatie de rudenie
		//preceding --> urca in sus in dom fara a avea nevoie de o relatie de rudenie
